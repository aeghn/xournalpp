...
public:
    ...
    virtual std::string selectHeadTailText(const XojPdfRectangle& rec) = 0;
    virtual cairo_region_t* selectHeadTailTextRegion(const XojPdfRectangle& rec) = 0;
    virtual void selectHeadTailFinally(const XojPdfRectangle& se, cairo_region_t** region,
                                       std::vector<XojPdfRectangle>* recs, std::string* text) = 0;
    virtual void selectAreaFinally(const XojPdfRectangle& rec, cairo_region_t** region,
                                   std::vector<XojPdfRectangle>* recs, std::string* text) = 0;
